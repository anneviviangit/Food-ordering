...
if($response['ResultCode']==0){
    header("https://academicscholars4hire.com/callback_url.php");

} elseif($response['ResultCode']==1032){
    echo "Request cancelled by user";
} elseif($response['ResultCode']==1037){
    echo "DS timeout user cannot be reached";
} else{
    echo "Invalid  entry Transaction failed";
}
